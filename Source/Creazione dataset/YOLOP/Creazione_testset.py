...
def detect(cfg,opt):
    ...
    class Creazione_VideoDataset():
        ...
        def __init__(self, directory, mode='Day', clip_len=8, num_sec=8):
            ...
            os.mkdir('testset_'+mode+'_num_sec_'+str(num_sec)+'_FPS_'+str((self.clip_len+1)/self.num_sec))
            ...
            for i in np.arange(len(self.origin_path)):
                ...
                for j in (np.arange(self.clip_len+1)):
                    ...
                    try:
                        ...
                        os.mkdir('testset_'+mode+'_num_sec_'+str(num_sec)+'_FPS_'+str((self.clip_len+1)/self.num_sec)+'/'+str(self.label_array2[i]))
                    except:
                        print("error")
                    try:
                        
                        os.mkdir('testset_'+mode+'_num_sec_'+str(num_sec)+'_FPS_'+str((self.clip_len+1)/self.num_sec)+'/'+str(self.label_array2[i])+'/'+str(i))
                    except:
                        print("error")
                    try:
    ...
    #========================================================================================================================   
                        ...
                        np.save('testset_'+mode+'_num_sec_'+str(num_sec)+'_FPS_'+str((self.clip_len+1)/self.num_sec)+'/'+str(self.label_array2[i])+'/'+str(i)+'/'+str(self.label_array2[i])+'_'+str(j)+'.npy', x)
    ...
    #testset with the number of frames specificized (mode is not an obligatory
    ...
    #conditions).
    x = Creazione_VideoDataset("testsetNight1_num_sec_8_FPS_22.0", clip_len=22*8, num_sec = 8, mode = "Night1")
